...
## Manufacturing >> Goods producting systems 
...
- Buyer and seller will have no interaction 
- Service sector - interaction between buyer and seller (person to 
person relationship)

- Highly seasonable demand example: 
Smooth out the sales cycle by building inventory count cyclically 
to peak demand. 
