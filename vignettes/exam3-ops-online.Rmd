...
raw material, to work in process, to a final produt. Raw materials get through 
the supply chain to where they are supposed to be and consumed by the end customer. 
...
enquiry as to the status of the order are answered by this individual 
...
1. Master Production Schedule (MPS) Scheduling people, reseources 
...
- Make new products
- Features 
- Constantly looking to imporve and change the quality of the product
- Disrupts the production flow and can create conflict 

### Human Resources HR 

Dealing with people and insurance and training
- Communicate personell needs to hr department - need to higher the right people. 
...
assembled/ manufacutrered in house and used in the production of a final product. 
...
- Dependent (derived): raw matierals, sub assemblies, components. 
...
- Carry costs (holding): 
  - storage - opportunity cost of the stroage area 
